...
| 5 | Platform: landing page with the horizontal instance cards and module badges, one subpage per registered instance, and the preparation page | WP3, WP4 | pages built 2026-08-20; the register still has to catch up, since the cover files exist while the `cover` fields stay empty and no field yet carries the module selection of an instance |
